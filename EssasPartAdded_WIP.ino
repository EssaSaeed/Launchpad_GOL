# Launchpad_GOL
# Game of Life on the Texas-Instrument Launchpad micro-processor.
//Instead of refreshing the cells, it randomizes when tilted at the moment (it is a WIP)
//Added some things, like the repopulate() function (and the ones at the end for the accelerometer)
